  ...
  <div class="site-wrap">
    ...
    <div class="unit-5 overlay" style="background-image: url('images/hero_bg_1.jpg');">
      <div class="container text-center">
        ...
        <p class="mb-0 unit-6"><a href="index.php">Home</a> <span class="sep">></span> <span>Domain</span></p>
      </div>
    </div>
            ...
            <form action="#" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="fullname" class="form-control rounded-0">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12">
              ...
              <div class="row form-group mb-5">
                <div class="col-md-12">
                  <label class="font-weight-bold" for="password2">Re-type Password</label>
                  <input type="password" id="password2" class="form-control rounded-0">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Register" class="btn btn-primary  py-2 px-4 rounded-0" id="cgc">
                </div>
              </div>
